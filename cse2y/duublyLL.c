...
Problem 3: (Case Study of Doubly Linked List):Write a
modular program to keep record of your society where
you are presently residing. A record must contain the
following attributes.
1. Aadhar Card Number/Social Security Number
(Primary Key)
2. Name of Person
3. Gender
4. Father’s Name
...
Define the following Methods/Functions

(a) Insert a record in the database
(b) Delete a record from the database
(c) Update a record

(d) Keep the record in sorted order (Desired Location
Insertion in the data base will important)
(e) Find/Search a record in the database
(f) Generate Report of desired attribute (Complete
Report based on the Aadhar Card Number, Partial
Report using the any other attribute of the
record).

Use Doubly Linked List Data Structure to define the
database.
User Interface is required bind all the methods together.
Note: A Temporary Doubly Linked List will be created for
every operation specially when report generated
*/
#include<stdio.h>
#include<malloc.h>
#include<stdlib.h>
...
void insert_dnode()
{
    ...
    ptr->next=NULL;
    ptr->prev=NULL;
    printf(" Aadhar Number enter \n");
    fflush(stdin);
    scanf("%12u",&ptr->aadhar_no);
    printf("Enter Name\n");
    fflush(stdin);
    scanf("%[^\n]",ptr->name);
    printf(" Gender choose from following number\n");
    int g_choice = 0;
    printf("[1]Male\n");
    printf("[2]Female\n");
    printf("[3]Other\n");
    while(scanf("%d",&g_choice))
    {
    ...
    fflush(stdin);
    scanf("%2hu %2hu %4hu",&ptr->dob.day,&ptr->dob.month,&ptr->dob.year);
    if(start==NULL)
    {
        start = ptr;
        end = ptr;
...
void delete_dnode()
{
    ...
    fflush(stdin);
    scanf("%12u",&delete_aadhar_number);
...
void update_dnode()
{
    ...
    while(1)
    {
        ...
        case 2:
        {
            printf("Choose the new Gender to update\n");
            int g_choice = 0;
            printf("[1]Male\n");
            printf("[2]Female\n");
            printf("[3]Other\n");
        ...
        case 5:
        {
            ...
            fflush(stdin);
            scanf("%2hu %2hu %4hu",&temp_ptr->dob.day,&temp_ptr->dob.month,&temp_ptr->dob.year);
...
void search_dnode()
{
    ...
    case 1:
    {
        ...
        printf("Enter the aadhar number\n");
        fflush(stdin);
        scanf("%12u",&search_aadhar_number);
    ...
    case 5:
    {
        ...
        fflush(stdin);
        scanf("%2hu %2hu %4hu",&search_dob.day,&search_dob.month,&search_dob.year);
        dnode* temp_ptr = start;
        int flag=0;
        while(temp_ptr!=NULL)
        {
...
void generate_report()
{
    ...
    case 1:
    {
        ...
        printf("Enter the aadhar number\n");
        fflush(stdin);
        scanf("%12u",&report_aadhar_number);
